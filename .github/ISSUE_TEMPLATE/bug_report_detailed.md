...
- [ ] Rust crate (`wickra-compile-core`)
- [ ] Python (`pip install wickra-compile`)
- [ ] Node.js (`npm install wickra-compile`)
- [ ] WASM
- [ ] C ABI (`bindings/c`)
- [ ] C# (`WickraCompile` on NuGet)
- [ ] Go (`bindings/go`)
- [ ] Java (`org.wickra:wickra-compile` on Maven Central)
- [ ] R (`bindings/r`)
- [ ] CLI (`wickra-compile`)
- [ ] Docs / examples only
...
| Field                | Value                                  |
| -------------------- | -------------------------------------- |
| Wickra Compile version       | `e.g. 0.4.2`                           |

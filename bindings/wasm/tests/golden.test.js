...
// `wasm-pack build --target nodejs --out-dir pkg-node`: the WebAssembly build
// generates the same deterministic manifest as every other binding. The
// require is hard: a missing build must fail the job, not skip it.

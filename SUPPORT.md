...
Thanks for using `wickra-compile`. Here is where to go for help.
...
- Open a [GitHub Discussion](https://github.com/wickra-lib/wickra-compile/discussions)
  for questions and ideas.

## Bugs and feature requests

Open a [GitHub issue](https://github.com/wickra-lib/wickra-compile/issues) using
...
`wickra-compile` is a research and engineering tool: it evaluates conditions
